...
image1 = cv2.imread('./functions/segmentedImages/adrenal-1-02-segment.bmp', cv2.IMREAD_GRAYSCALE)
...
image2 = cv2.imread('./functions/segmentedImages/selected_segment_1.bmp', cv2.IMREAD_GRAYSCALE)
